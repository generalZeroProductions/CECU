      ...
      <div class="8u  12u(narrower) important(narrower)">
        <div id="content">
          <section id="personalInfoFeedback">
              <h4 class="heading">重看室友的信息 </h4>
							<hr>
                <div class="row 50%">
                  <div class="6u 12u(mobilep)">
                        <label  class="preformattedResponse"> 室友的名字 ： </label>
                  </div>
                  ...
                  <div class="6u 12u(mobilep)">
                    <label class="preformattedResponse"> 室友的姓名 ： </label>
                  </div>
                  <div class="6u 12u(mobilep)">
                    ...
                    <div class="row 50%">
                    <div class="6u 12u(mobilep)">
                        <label class="preformattedResponse"> 室友的電子郵件地址 ： </label>
                    </div>
                    <div class="6u 12u(mobilep)">
                    ...
                    <div class="6u 12u(mobilep)">
                      <label  class="preformattedResponse"> 您的室友的電話號碼 ： </label>
                    </div>
                    <div class="6u 12u(mobilep)">
                  ...
                  <h4 class="heading">重看您的信息 </h4>
                    ...
                    <div class="row 50%">
                      ...
                      <div class="6u 12u(mobilep)">
                        ...
                        <div class="12u">
                          <a href="register_edit_shared.php" class="button">更改</a>
                        </div>
                        </div>
...
<br>
                        <form action="register_confirm_shared.php" method="post" class="payment-form">
                          ...
                          <br>
                        <input id="greenPay" type="submit" class="button altGreen" value="提交付款 $2576.00"></input>
                      </form>
                  </div>
                  </div>
